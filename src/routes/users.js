...
// Use bcryptjs to avoid installation issues; switch to bcrypt if installed
const bcrypt = require('bcryptjs'); // Change to 'bcrypt' if installed
...
router.post('/login', [
  ...
  try {
    ...
    // Create user object for response, excluding sensitive data
    const userResponse = {
